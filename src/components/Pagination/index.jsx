...
function Pagination(props) {
  ...
  const PAGE_ITEMS_TO_SHOW = links.filter(
    (page, index) => page.url
      && (
        index < 2
        || Math.abs(index - activePageIndex) < 4
      ...
      <ul className="pagination justify-content-center">
        {
          PAGE_ITEMS_TO_SHOW
            ...
            .map((page, index) => {
              ...
              //  1 2 ... 4
              const PAGE_LABEL = (
                Math.abs(index - activePageIndex) === 3
                && index > 1
                && index < PAGE_ITEMS_TO_SHOW.length - 2
                && PAGE_NUMBER > 2
